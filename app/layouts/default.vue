<template>
  <div class="min-h-screen bg-gray-50">
    ...
    <Transition enter-active-class="transition duration-300 transform" enter-from-class="-translate-x-full"
      enter-to-class="translate-x-0" leave-active-class="transition duration-200 transform"
      leave-from-class="translate-x-0" leave-to-class="-translate-x-full">
      <aside v-if="isSidebarOpen" class="fixed inset-y-0 left-0 w-64 z-40 md:hidden">

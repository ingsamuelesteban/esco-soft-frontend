        ...
        <div class="mt-3">
          ...
          <div class="mb-4">
            ...
            <input v-model="valorRAActual" type="number" min="0" :max="porcentajeDisponible" step="0.1"
              ...
              class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 disabled:bg-gray-100 disabled:dark:bg-gray-800 disabled:cursor-not-allowed"
...
const cargarModulosYEstudiantes = async () => {
  ...
  try {
    ...
    modulosDisponibles.value = assignments.map(assignment => ({
      ...
      profesor_id: assignment.profesor_id, // Needed for coordinator permission check

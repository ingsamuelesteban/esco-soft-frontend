                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-6">
                    ...
                    <div v-if="submission?.extension_status && submission.extension_status !== 'none'" class="mb-4">
                        <div v-if="submission.extension_status === 'pending'"
                            class="bg-yellow-50 dark:bg-yellow-950/30 border-l-4 border-yellow-400 p-4 rounded-r-lg">
                            <div class="flex">
                        ...
                        <div v-else-if="submission.extension_status === 'approved'"
                            class="bg-green-50 dark:bg-green-950/30 border-l-4 border-green-400 p-4 rounded-r-lg">
                            <div class="flex">
                                <div class="flex-shrink-0">
                        ...
                        <div v-else-if="submission.extension_status === 'rejected'"
                            class="bg-red-50 dark:bg-red-950/30 border-l-4 border-red-400 p-4 rounded-r-lg">
                            <div class="flex">
                                <div class="flex-shrink-0">

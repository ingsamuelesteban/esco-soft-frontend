    ...
    <div class="space-y-6">
        ...
        <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Mis Casos Reportados</h1>
                    <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Seguimiento de estudiantes reportados a Psicología</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-4 h-[calc(100vh-180px)] min-h-[600px)] flex flex-col">
            ...
            <div class="border-b border-gray-200 dark:border-gray-700 mb-4">
                <nav class="-mb-px flex space-x-8" aria-label="Tabs">
                    <a href="#" @click.prevent="mainTab = 'cases'"
                        :class="[mainTab === 'cases' ? 'border-indigo-500 text-indigo-600' : 'border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:text-gray-300 hover:border-gray-300 dark:border-gray-600', 'whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm']">
                        Casos Psicológicos
                    </a>
                    <a href="#" @click.prevent="mainTab = 'warnings'"
                        :class="[mainTab === 'warnings' ? 'border-amber-500 text-amber-600' : 'border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:text-gray-300 hover:border-gray-300 dark:border-gray-600', 'whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm']">
                        Advertencias
                    </a>
                </nav>
            </div>
            ...
            <div v-if="mainTab === 'cases'" class="flex-1">
                <div v-if="viewMode === 'list'">
                    <div class="flex items-center justify-between mb-4 border-b border-gray-200 dark:border-gray-700">
                        <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100 pb-2">Mis Casos</h2>
                        <nav class="-mb-px flex space-x-8" aria-label="Tabs">
            ...
            <div v-if="mainTab === 'warnings'" class="flex-1">
                <div v-if="warningViewMode === 'list'">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="mt-1 relative rounded-md shadow-sm">
                                <input type="text" name="search" id="search" v-model="warningSearch"
                                    class="focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-3 sm:text-sm border-gray-300 dark:border-gray-600 rounded-md"
                    ...
                    <div class="flex items-center justify-between mb-4 border-b border-gray-200 dark:border-gray-700">
                        <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100 pb-2">Mis Advertencias</h2>
                        <nav class="-mb-px flex space-x-8" aria-label="Tabs">
                            <a href="#" @click.prevent="warningFilter = 'open'"
                                :class="[warningFilter === 'open' ? 'border-amber-500 text-amber-600' : 'border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:text-gray-300 hover:border-gray-300 dark:border-gray-600', 'whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm']">
                                Abiertas
                            ...
                            <a href="#" @click.prevent="warningFilter = 'closed'"
                                :class="[warningFilter === 'closed' ? 'border-amber-500 text-amber-600' : 'border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:text-gray-300 hover:border-gray-300 dark:border-gray-600', 'whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm']">
                                Cerradas

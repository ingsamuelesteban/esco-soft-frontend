<template>
  <section>
    <header class="flex items-center justify-between">
      <div>
        <h1 class="text-2xl font-semibold text-gray-900 dark:text-gray-100">Familias Profesionales</h1>
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Gestión de familias profesionales del centro.</p>
      </div>
      <div>

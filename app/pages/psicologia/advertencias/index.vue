    ...
    <div class="space-y-6">
        ...
        <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Gestión de Advertencias</h1>
                    <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Supervisión y seguimiento de advertencias estudiantiles</p>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-4 h-[calc(100vh-180px)] min-h-[600px] flex flex-col">
            <div v-if="viewMode === 'list'">
                <div class="mb-4">
                    <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100 pb-4">Listado de Advertencias</h2>
                        ...
                        <div class="sm:col-span-4">
                            ...
                            <div class="mt-1 relative rounded-md shadow-sm">
                                <input type="text" name="search" id="search" v-model="search"
                                    class="focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-3 sm:text-sm border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
                                    placeholder="Nombre, apellido o cédula">
                            </div>
                        </div>

                        <div class="sm:col-span-4">
                            <label for="reported_by" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Reportado
                                Por</label>
                        ...
                        <div class="flex space-x-4">
                            ...
                            <nav class="-mb-px flex space-x-8" aria-label="Tabs">
                                <a href="#" @click.prevent="filter = 'open'"
                                    :class="[filter === 'open' ? 'border-amber-500 text-amber-600' : 'border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:text-gray-300 hover:border-gray-300 dark:border-gray-600', 'whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm']">
                                    Abiertas
                                ...
                                <a href="#" @click.prevent="filter = 'closed'"
                                    :class="[filter === 'closed' ? 'border-amber-500 text-amber-600' : 'border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:text-gray-300 hover:border-gray-300 dark:border-gray-600', 'whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm']">
                                    Historial (Cerradas)

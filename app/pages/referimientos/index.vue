    ...
    <div class="space-y-6">
        ...
        <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Reportes a Psicología</h1>
                    <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Seleccione un aula y los estudiantes que desea reportar.</p>
                </div>
            </div>
        </div>
        ...
        <div v-if="hasData" class="bg-white dark:bg-gray-800 shadow-sm rounded-lg">
            <div
                class="p-4 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center sticky top-0 z-10 bg-white dark:bg-gray-800 shadow-sm rounded-t-lg">
                <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100">Estudiantes</h3>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                        <tr v-for="record in records" :key="record.estudiante.id" class="hover:bg-gray-50 dark:bg-gray-900/50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <div class="text-sm font-medium text-gray-900 dark:text-gray-100">{{ record.estudiante.apellidos
                                        }}, {{ record.estudiante.nombres }}</div>
                                        <div class="text-sm text-gray-500 dark:text-gray-400">{{ record.estudiante.cedula || 'Sin cédula'
                                        }}</div>
                                    </div>
                                </div>
                            </td>
        ...
        <div v-else-if="!hasData" class="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-12 text-center">
            <svg class="mx-auto h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
            </svg>
            <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-gray-100">Seleccione una clase</h3>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Seleccione una materia y aula para ver la lista de estudiantes.</p>
        </div>
                ...
                <div
                        ...
                        <div class="mt-4">
                            <form @submit.prevent="submitReferral" class="space-y-4">
                                    ...
                                    <div class="grid grid-cols-2 gap-3">
                                        <button type="button" @click="form.reportType = 'case'" :class="[
                                            form.reportType === 'case'
                                                ...
                                                : 'bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:bg-gray-900/50',
                                ...
                                <div v-if="form.reportType === 'case' && !isPsychologistRole">
                                    ...
                                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Si se deja en blanco, el sistema asignará
                                        automáticamente.</p>
                                </div>
                                <div>
                                ...
                                <div v-if="form.reportType === 'case'" class="flex items-start">
                                    ...
                                    <div class="ml-3 text-sm">
                                        <label for="send_student" class="font-medium text-gray-700 dark:text-gray-300">¿Enviar estudiante a
                                            psicología?</label>
                                        <p class="text-gray-500 dark:text-gray-400">Marque esta opción si el estudiante debe presentarse al
                    ...
                    <div class="bg-gray-50 dark:bg-gray-900/50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                        ...
                        <button type="button" @click="closeModal"
                            class="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 dark:border-gray-600 shadow-sm px-4 py-2 bg-white dark:bg-gray-800 text-base font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:bg-gray-900/50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm">
                            Cancelar
                        </button>
                    </div>
                </div>

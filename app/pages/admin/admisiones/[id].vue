  ...
  <div class="space-y-6 max-w-5xl mx-auto pb-12">
    ...
    <div v-else-if="estudiante" class="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <div class="lg:col-span-2 space-y-6">
          ...
          <div class="p-6">
            <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-6">
              ...
              <div>
                ...
                <dd class="mt-1 text-sm text-gray-900 dark:text-gray-100">{{ formatDate(estudiante.fecha_nacimiento) }} <span class="text-gray-500 dark:text-gray-400 text-xs">({{ edadCalculada }})</span></dd>
              </div>
              <div>
              ...
              <div>
                <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Estado de Cuenta</dt>
              ...
              <div>
                ...
                <dd class="mt-1 text-sm text-gray-900 dark:text-gray-100">
                  <div v-if="estudiante.admision?.recomendado">
                    ...
                    <span v-if="estudiante.admision?.recomendado_por" class="ml-2 text-xs text-gray-500 dark:text-gray-400 font-normal italic">
              ...
              <div class="sm:col-span-2">
                ...
                <dd class="text-sm text-gray-900 dark:text-gray-100 flex flex-wrap gap-2">
                  <template v-if="estudiante.historia_clinica?.discapacidades?.length">
                    <span v-for="d in estudiante.historia_clinica.discapacidades" :key="d" class="inline-flex items-center rounded-md bg-gray-100 dark:bg-gray-800 px-2.5 py-0.5 text-xs font-medium text-gray-800 dark:text-gray-200">{{ d }}</span>
                  </template>
        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded-xl overflow-hidden">
          <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/50">
            <h3 class="text-base font-semibold text-gray-900 dark:text-gray-100">Familiares Registrados ({{ estudiante.familiares?.length || 0 }})</h3>
          </div>
              ...
              <div v-for="fam in estudiante.familiares" :key="fam.id" class="p-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
                  ...
                  <div>
                    ...
                    <span class="block text-sm text-gray-900 dark:text-gray-100 mt-1">{{ fam.profesion_oficio || 'N/A' }} <span class="text-gray-400 text-xs">({{ fam.nivel_academico || 'N/A' }})</span></span>
                  </div>
                  <div>
      ...
      <div class="space-y-6">
        ...
        <div class="bg-primary-50 border border-primary-100 rounded-xl p-6 text-center">
          ...
          <h2 class="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-1">Folder No. {{ estudiante.admision?.no_folder || '...' }}</h2>
          ...
          <div class="border-t border-primary-200 pt-4 flex justify-between items-center px-2">
            ...
            <span v-else class="inline-flex items-center rounded-full bg-gray-100 dark:bg-gray-800 px-2.5 py-0.5 text-xs font-semibold text-gray-800 dark:text-gray-200">
              <svg class="mr-1 h-3 w-3" fill="currentColor" viewBox="0 0 8 8"><circle cx="4" cy="4" r="3" /></svg>
              NO
            </span>
          </div>
          ...
          <div class="p-6">
            <ul class="space-y-3">
              <li class="flex items-center text-sm">
                ...
                <span :class="[estudiante.historia_clinica?.documento_acta_nacimiento ? 'text-gray-900 dark:text-gray-100' : 'text-gray-500 dark:text-gray-400']">Acta de Nacimiento</span>
              </li>
              <li class="flex items-center text-sm">
                ...
                <span :class="[estudiante.historia_clinica?.documento_record_notas ? 'text-gray-900 dark:text-gray-100' : 'text-gray-500 dark:text-gray-400']">Récord de Notas</span>
              </li>
              <li class="flex items-center text-sm">
                ...
                <span :class="[estudiante.historia_clinica?.documento_certificado_sigerd ? 'text-gray-900 dark:text-gray-100' : 'text-gray-500 dark:text-gray-400']">Certificado SIGERD</span>
              </li>
              <li class="flex items-center text-sm">
                ...
                <span :class="[estudiante.historia_clinica?.documento_buena_conducta ? 'text-gray-900 dark:text-gray-100' : 'text-gray-500 dark:text-gray-400']">Buena Conducta</span>
              </li>
              <li class="flex items-center text-sm">
                ...
                <span :class="[estudiante.historia_clinica?.documento_fotos ? 'text-gray-900 dark:text-gray-100' : 'text-gray-500 dark:text-gray-400']">Fotos 2x2</span>
              </li>
              <li class="flex items-center text-sm">
                ...
                <span :class="[estudiante.historia_clinica?.documento_certificado_medico ? 'text-gray-900 dark:text-gray-100' : 'text-gray-500 dark:text-gray-400']">Certificado Médico</span>
              </li>
              <li class="flex items-center text-sm">
                ...
                <span :class="[estudiante.historia_clinica?.documento_tarjeta_vacuna ? 'text-gray-900 dark:text-gray-100' : 'text-gray-500 dark:text-gray-400']">Tarjeta Vacunas</span>
              </li>
              <li class="flex items-center text-sm">
                <svg :class="[estudiante.historia_clinica?.documento_copia_cedula_padres ? 'text-green-500' : 'text-gray-300', 'h-5 w-5 mr-3 shrink-0']" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" /></svg>
                <span :class="[estudiante.historia_clinica?.documento_copia_cedula_padres ? 'text-gray-900 dark:text-gray-100' : 'text-gray-500 dark:text-gray-400']">Copia Cédula Padres</span>
              </li>
            </ul>
          </div>
        </div>

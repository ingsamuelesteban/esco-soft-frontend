  ...
  <div class="space-y-1">
    ...
    <div class="relative">
      ...
      <input
        ...
        :disabled="disabled"
        :required="required"
        class="block w-full pl-12 pr-3 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
        :class="{

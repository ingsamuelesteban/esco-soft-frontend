        ...
        <div class="p-4 space-y-4">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <select ref="initialFocus" v-model.number="form.anio_lectivo_id" :disabled="isTeacher" class="border dark:border-gray-600 rounded px-2 py-2 w-full bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 disabled:opacity-50">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <select v-model.number="form.materia_id" :disabled="isTeacher" class="border dark:border-gray-600 rounded px-2 py-2 w-full bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 disabled:opacity-50">
                <option :value="undefined">Seleccionar…</option>
            ...
            <div>
              ...
              <select v-model.number="form.profesor_id" :disabled="isTeacher" class="border dark:border-gray-600 rounded px-2 py-2 w-full bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 disabled:opacity-50">
                <option :value="undefined">Seleccionar…</option>
            ...
            <div>
              ...
              <select v-model.number="form.aula_id" :disabled="isTeacher" class="border dark:border-gray-600 rounded px-2 py-2 w-full bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 disabled:opacity-50">
                <option :value="undefined">Seleccionar…</option>
          ...
          <div class="mt-2">
            <label class="inline-flex items-center">
              <input type="checkbox" v-model="form.compartido" :disabled="isTeacher"
                class="rounded border-gray-300 dark:border-gray-600 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50 disabled:opacity-50">

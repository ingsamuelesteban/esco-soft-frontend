      ...
      <div v-for="req in requests" :key="req.id"
        ...
        <div class="mt-auto flex items-center justify-between">
          ...
          <NuxtLink to="/personal/permisos" 
            class="inline-flex items-center gap-1 text-[11px] font-bold text-orange-600 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:bg-gray-900/50 px-3 py-1.5 rounded-lg shadow-sm transition-all focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 focus:ring-offset-orange-600">
            Revisar

        ...
        <form @submit.prevent="handleSubmit">
          ...
          <div class="bg-gray-50 dark:bg-gray-900/50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
            ...
            <button type="button" @click="$emit('close')" :disabled="loading"
              class="px-3 py-2 rounded border bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:bg-gray-900/50 transition sm:mr-3 disabled:opacity-50">Cancelar</button>
          </div>
        </form>
      </div>
    </div>

                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                            ...
                            <div class="mt-2">
                                <p class="text-sm text-gray-500 dark:text-gray-400 mb-4">
                                    Estudiante: <span class="font-bold text-gray-800 dark:text-gray-200">{{ studentName }}</span>
                                </p>
                                ...
                                <form @submit.prevent="handleSubmit" class="space-y-4">
                                    ...
                                    <div>
                                        <label for="assigned_to" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Asignar
                                            a
                                            (Opcional)</label>
                                    ...
                                    <div class="flex items-start">
                                        ...
                                        <div class="ml-3 text-sm">
                                            <label for="send_student" class="font-medium text-gray-700 dark:text-gray-300">¿Enviar
                                                estudiante a psicología?</label>
                                            <p class="text-gray-500 dark:text-gray-400">Marque esta opción si el estudiante debe

    ...
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
      ...
      <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full">
        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
          ...
          <div class="mb-6 p-4 rounded-md"
            ...
            <div class="flex items-center">
              <svg v-if="estadoFinal === 'Logrado'" class="h-5 w-5 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
              ...
              <span class="text-sm font-medium"
                    :class="estadoFinal === 'Logrado' ? 'text-green-800' : 'text-gray-800'">
            ...
            <form @submit.prevent="guardarCalificacion">
              <div class="space-y-4">
                <div>
                  ...
                  <select v-model="form.estado" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
        ...
        <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
          <button v-if="puedeAgregarOportunidad" 
                  type="submit" 

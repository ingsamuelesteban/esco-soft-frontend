  ...
  <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg overflow-hidden">
    <div class="p-4">
      <div class="flex items-center gap-3 flex-wrap">
        ...
        <button @click="handlePrint" :disabled="printLoading"
          class="ml-2 px-3 py-2 text-sm bg-gray-600 text-white rounded-md hover:bg-gray-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors inline-flex items-center shadow-sm"
          title="Imprimir Listado">
          <svg v-if="printLoading" class="animate-spin -ml-1 mr-2 h-4 w-4 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
            <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
          ...
          {{ printLoading ? 'Generando...' : 'Imprimir Listado' }}
        </button>

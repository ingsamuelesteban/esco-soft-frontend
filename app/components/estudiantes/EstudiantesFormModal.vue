      ...
      <form @submit.prevent="onSubmit">
        <div class="p-4 space-y-4">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              <label class="block text-sm text-gray-600 mb-1">RNE <span class="text-red-500">*</span></label>
        ...
        <div class="px-4 py-3 border-t flex items-center justify-end gap-2">
          ...
          <button type="submit" class="px-3 py-2 rounded bg-blue-600 text-white hover:bg-blue-700 transition disabled:opacity-50 disabled:cursor-not-allowed"
            :disabled="loading">
...
const onSubmit = async () => {
  ...
  if (!form.cedula.trim()) errors.cedula = 'Requerido'
  if (!form.sexo) errors.sexo = 'Requerido'
  if (!form.rne.trim()) errors.rne = 'Requerido'

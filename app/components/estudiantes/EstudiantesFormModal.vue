    ...
    <div class="bg-white dark:bg-gray-800 w-full max-w-2xl rounded-lg shadow-xl overflow-hidden">
      ...
      <form @submit.prevent="onSubmit">
        <div class="p-4 space-y-4">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div v-if="!isEdit">
              ...
              <select v-model="form.anio_lectivo_id"
               ...
               <p class="text-xs text-gray-500 dark:text-gray-400 mt-1" v-if="anioSeleccionado && !anioSeleccionado.activo">
          ...
          <!-- Orden Manual -->
          <div v-if="form.aula_id" class="sm:col-span-2 bg-gray-50 dark:bg-gray-900/50 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between">
              <div>
                <h4 class="text-sm font-medium text-gray-900 dark:text-gray-100">Ordenamiento Manual</h4>
                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Activar solo para excepciones (ej. inscripciones tardías fuera de
                  orden alfabético).</p>
              </div>

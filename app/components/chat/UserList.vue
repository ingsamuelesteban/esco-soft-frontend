<template>
    <div class="h-full flex flex-col">
        <div class="p-3 border-b border-gray-100 dark:border-gray-700 flex items-center gap-2">
            <button @click="$emit('cancel')" class="p-1 hover:bg-gray-100 dark:bg-gray-800 rounded-full">
            ...
            <h3 class="font-bold text-gray-700 dark:text-gray-300">Nuevo Chat</h3>
        </div>

        <div class="p-2 border-b border-gray-100 dark:border-gray-700">
            <input type="text" placeholder="Buscar usuario..." v-model="searchQuery"
                class="w-full text-sm px-3 py-2 bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-700 rounded-md focus:ring-1 focus:ring-blue-500 focus:border-blue-500">
        </div>
        ...
        <ul v-else class="divide-y divide-gray-100 dark:divide-gray-700 overflow-y-auto flex-1">
            <li v-for="user in filteredUsers" :key="user.id" @click="startChat(user)"
                class="p-3 hover:bg-gray-50 dark:bg-gray-900/50 cursor-pointer flex items-center gap-3 transition">
                <div
            ...
            <li v-if="filteredUsers.length === 0" class="p-4 text-center text-gray-500 dark:text-gray-400 text-sm">
